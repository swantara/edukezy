                        ...
                        <form onsubmit="return confirm('Pilih OK untuk melanjutkan.');" action="function/update_mapel.php" method="post">
                            ...
                            if($rowcount > 0){
                                while($row = mysql_fetch_array($result)){
                                    $tingkatMapel = $row['tingkat_pendidikan'];
                            ?>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label>Tingkat</label>
                                    <select class="form-control" name='tingkat' data-placeholder="Pilih Tingkat" style="width: 100%;">
                                        ...
                                        if($rowcountC > 0){
                                            while($rowC = mysql_fetch_array($resultC)){
                                                ...
                                                <option value="<?= $rowC['id'];?>" selected><?php echo $rowC['nama'];?></option>
                                        ...
                                        if($rowcountD > 0){
                                            while($rowD = mysql_fetch_array($resultD)){
                                                if($rowD['id']!=$tingkatMapel){
                                                    ?>

                                                    <option value="<?= $rowD['id'];?>"><?php echo $rowD['nama'];?></option>
