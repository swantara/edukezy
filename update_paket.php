      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <form onsubmit="return confirm('Pilih OK untuk melanjutkan.');" action="function/update_paket.php" method="post">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input name="jumlah_pertemuan" type="text" class="form-control" id="jumlah_pertemuan" value="<?php echo $row['jumlah_pertemuan'];?>">
              </div>
              <div class="form-group">
                <label for="durasi">Durasi / Pertemuan (menit)</label>
                <input name="durasi" type="text" class="form-control" id="durasi" value="<?php echo $row['durasi'];?>">
              </div>
              <div class="form-group">
                <label for="harga">Biaya (Rp.)</label>
                <input name="harga" type="text" class="form-control" id="harga" value="<?php echo $row['harga'];?>">
              </div>
