...
<head>
    ...
    <title>Edukezy | Pembatalan Jadwal</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Edukezy
                <small>Kelola Permintaan Pembatalan Jadwal</small>
            </h1>
        </section>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary"
                                                    <?php if($_SESSION['status']!=4){ ?>
                                                        onClick="Javascript:window.location.href = 'detail_canceljadwal.php?id=<?php echo $row['id'] ?>';"
                                                    <?php } ?>>
                                                    <div class="pull-left">
