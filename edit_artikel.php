          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <br/><br/>
                <img src="dist/img/user2-160x160.jpg" width="200px" height="200px" alt="Article Image">
                <br/><br/>
                <input type="file" id="fotoArtikel">
              </div>
              <div class="form-group">
                <label for="judulArtikel">Judul Artikel</label>
                <input type="text" class="form-control" id="judulArtikel" value="judul">
              </div>
              <div class="form-group">
                <label>Konten</label>
                <form>
                  <textarea id="konten" name="konten" rows="10" cols="80">
                    Isi artikel yang lamaa...
                  </textarea>
                </form>
              </div>
              <!-- /.form group -->
