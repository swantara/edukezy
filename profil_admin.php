          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <?php
                ...
                FROM 
                  tb_admin AS a
                INNER JOIN tb_users AS u ON u.id=a.admin_id
                WHERE
                  a.admin_id=$id_param";
              ...
              ?>
              <img class="profile-user-img img-responsive img-circle" alt="User profile picture" src="<?=$IMG_ADMIN . $row['photo'];?>">
              <?php 
                }
              ?>
              <h3 class="profile-username text-center"><?php echo $row['fullname'];?></h3>
              <input name='id' id='id' value='".$id."' type='hidden'>
              <button type="button" class="btn btn-primary btn-block" name='detail_$id' onClick="Javascript:window.location.href = 'update_admin.php?id=<?php echo $row['id'] ?>';">
