        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <a href="tambah_owner.php" class="btn btn-primary"><i class="fa fa-user-plus"></i> Tambah Owner</a>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    FROM 
                      tb_owner AS o
                    JOIN tb_cabang AS c on c.id=o.zona_id
                    ORDER BY
                      o.fullname";
                ...
                <tr>
                  ...
                  <td><?php echo $row['owner_cp'];?></td>
                  <td><?php echo $row['owner_alamat'];?></td>
                  <td>
                    <a class="btn btn-default" href="<?php echo $IMG_OWNER . $row['photo'];?>">
