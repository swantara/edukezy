...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- /.row -->
            <?php if($rReq['status'] == 2): ?>
                <div class="row">
                    <div class="col-md-2">
                        <a href="function/approve_canceljadwal.php?id=<?= $rReq['id'] ?>" class="btn btn-block btn-success">Setujui Permintaan</a>
                    </div>
                    <div class="col-md-2">
                        <a href="function/decline_cancelrequest.php?id=<?= $rReq['id'] ?>" class="btn btn-block btn-warning">Batalkan Permintaan</a>
                    </div>
                </div>
            <?php endif; ?>
