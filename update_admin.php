          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id='namaAdmin' name='namaAdmin' value="<?php echo $row['fullname'];?>">
              </div>
              <div class="form-group">
                <label for="alamatAdmin">Alamat</label>
                <input type="text" class="form-control" id='alamatAdmin' name='alamatAdmin' value="<?php echo $row['admin_alamat'];?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
