                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group-vertical">
                      ...
                      <button type="button" class="btn btn-default" name='detail_$id' onClick="Javascript:window.location.href = 'function/pembayaran_valid.php?id= <?php echo $row['id'] ?>';">
                        <div class="pull-left">
                          <i class="fa fa-check text-green"></i> Valid
                        </div>
                      </button>
                      <button type="button" class="btn btn-default" name='detail_$id' onClick="Javascript:window.location.href = 'function/pembayaran_invalid.php?id= <?php echo $row['id'] ?>';">
                        <div class="pull-left">
