...
<head>
  ...
  <title>Edukezy | Pembayaran</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="alert alert-success alert-dismissible">
        ...
        Berikut adalah list pembayaran yang telah diverifikasi.
      </div>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
                ...
                <tr>
                  ...
                  <td>
                    <?php 
                      ...
                      elseif ($row['pembayaran_metode'] == 2) {
                        ?>
                        <a class="btn btn-default" href="<?php echo "edukezy.com/images/buktipembayaran/" . $row['image'];?>">
