...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edukezy
        <small>Informasi Pertemuan</small>
      </h1>
    </section>
    ...
    <section class="content">
      <div class="alert alert-success alert-dismissible">
        ...
        Berikut adalah list pertemuan yang sudah dilakukan
      </div>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo date_format(date_create($row['tgl_pertemuan']), 'j/n/Y');?></td>
                  <td><?php echo date_format(date_create($row['waktu_mulai']), 'G:i') . " - " . date_format(date_create($row['waktu_selesai']), 'G:i');?></td>
                  ...
                  <td>
                    <?php 
                      ...
                      elseif($row['status'] == 2){
                        echo '<i class="fa fa-check text-green"></i> Complete';
                      }
                    ?>
                </tr>
