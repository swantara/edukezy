          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="namaCabang" value="<?php echo $row['nama'];?>">
              </div>
              <div class="form-group">
                <label for="alamatCabang">Alamat</label>
                <input type="text" class="form-control" id="alamatCabang" value="<?php echo $row['alamat'];?>">
              </div>  
              <div class="form-group">
                <label for="longitude">Longitude</label>
                <input type="text" class="form-control" id="longitude" value="<?php echo $row['logitude'];?>">
              </div>
              <div class="form-group">
